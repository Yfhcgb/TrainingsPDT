...
public class TestBase {
	...
	protected void goToHomePageContact() {
	...
	protected void fillContactForm(ContactData contact) {
	    ...
	    else {new Select(driver.findElement(By.name("bday"))).selectByVisibleText(contact.birthDay);};
	    if(contact.birthMonth==""){System.out.println("-");}
	    else {new Select(driver.findElement(By.name("bmonth"))).selectByVisibleText(contact.birthMonth);};
